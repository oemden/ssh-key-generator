...
- Custom comment user@host vs Keyname as comment
- Include the type in the ssh Key comment (default: false) - syntax: `id_<type>_<name>` example: `id_ed25519_my_server_key`
